...
public class OpenSettingsService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent intentToStart= new Intent(getApplicationContext(), MainActivity.class);
        /**
        ...
        checkIfPermissionGranted= new CountDownTimer(200000, 1000) {
            ...
            public void onTick(long l) {
                ...
                if(mode == MODE_ALLOWED) {
                    Intent intentToOpenAppAgain= new Intent(getApplicationContext(), MainActivity.class);
